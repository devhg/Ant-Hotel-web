    ...
    <a-card :bordered="false" class="ant-pro-components-tag-select">
      <a-form :form="form" layout="inline">
        <standard-form-row title="所属类目" block style="padding-bottom: 11px;">
          <a-form-item>
            <tag-select>
              <tag-select-option value="Category1">总统套房</tag-select-option>
              <tag-select-option value="Category2">大床房</tag-select-option>
              <tag-select-option value="Category3">标准套间</tag-select-option>
              <tag-select-option value="Category4">VIPⅠ</tag-select-option>
