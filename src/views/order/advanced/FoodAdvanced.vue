...
<template>
  ...
  >
    <detail-list slot="headerContent" size="small" :col="2" class="detail-layout">
      ...
      <detail-list-item term="用餐券">{{info.cost}}</detail-list-item>
      <detail-list-item term="消费金额">{{info.coupon}}</detail-list-item>
      <!-- <detail-list-item term="关联单据">
        <a>12421</a>
      </detail-list-item> -->
      <!-- <detail-list-item term="生效日期">{{info.startTime}} ~ {{info.endTime}}</detail-list-item> -->
      <detail-list-item term="备注">{{info.food}}</detail-list-item>
    </detail-list>
...
import { getFoodList } from '../../../api/manage'
